...
namespace g3 {
	...
	public class Remesher : MeshRefinerBase
    {
        ...
        public void ReprojectToSurface()
        {
            FullProjectionPass();
        }

        public void ReprojectToSurface(double projectionAlpha, double maxProjectDistance)
        {
            FullProjectionPass(projectionAlpha, maxProjectDistance);
        }
